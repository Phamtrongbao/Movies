...
<div className="box">
    ...
    <div id="popup1" className="overlay">
      ...
      <iframe width={1500} height={550} src={film.trailer} title="React Responsive Portfolio Website Tutorial Using ReactJs | React js Projects for Beginners | Deploy" frameborder={50} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen />
